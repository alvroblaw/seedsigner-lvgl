...
static const mp_obj_type_t uiseedsigner_event_type;

static mp_obj_t make_event_obj(ss_event ev) {
    uiseedsigner_event_obj_t* obj = m_new_obj(uiseedsigner_event_obj_t);
    obj->base.type = &uiseedsigner_event_type;
...
static mp_obj_t runtime_make_new(const mp_obj_type_t* type, size_t n_args, size_t n_kw, const mp_obj_t* args) {
    ...
    uiseedsigner_runtime_obj_t* self = m_new_obj(uiseedsigner_runtime_obj_t);
    self->base.type = type;
...
static const mp_obj_type_t uiseedsigner_runtime_type = {
    { &mp_type_type },
    .name = MP_QSTR_UiRuntime,
    .print = runtime_print,
    .make_new = runtime_make_new,
    .locals_dict = (mp_obj_dict_t*)&runtime_locals_dict,
};
